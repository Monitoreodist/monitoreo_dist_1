...
def enviar_email(mensaje):
    ...
    # Construcción del HTML del correo con formato mejorado
    html_content = f"""
    <html>
    <head>
        <style>
    ...
    msg.attach(MIMEText(mensaje, "plain", "utf-8"))  # Versión en texto plano
    msg.attach(MIMEText(html_content, "html", "utf-8"))  # Versión HTML mejorada
    ...
    try:
        ...
        print(f"❌ Error al enviar el correo: {e}")def enviar_email(detalles_cambios):
